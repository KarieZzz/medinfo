...
class Document extends Model
{
    ...
    public static $state_labels = [
        2 => 'Выполняется', 3 => 'Подготовлен к предварительной проверке', 4 => 'Подготовлен к проверке', 8 => 'Принят', 16 => 'Возвращен на доработку', 32 => 'Утвержден'
    ];
    public static $state_aliases = [
        2 => 'performed', 3 => 'inadvance', 4 => 'prepared', 8 => 'accepted', 16 => 'declined', 32 => 'approved'
    ];
    public static $state_aliases_keys = [
        'performed' => 2, 'inadvance' => 3, 'prepared' => 4, 'accepted' => 8, 'declined' => 16, 'approved' => 32
    ];
