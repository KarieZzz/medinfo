            ...
            localization =
             {
                 ...
                 groupsheaderstring: "Перетащите столбец сюда для группировки по этому столбцу",
                 ...
                 filterchoosestring: "Пожалуйста выбирите:",
                 filterstringcomparisonoperators: ['содержит', 'содержит(с учетом регистра)',
                     'не содержат', 'не содержит (с учетом регистра)', 'начинается с', 'начинается с(с учетом регистра)',
                     'оканчивается на', 'оканчивается на (с учетом регистра)', 'равно', 'равно (с учетом регистра)', 'null', 'not null'],
                 filternumericcomparisonoperators: ['равно', 'не равно', 'меньше', 'меньше или равно', 'больше', 'больше или равно', 'null', 'not null'],
                 filterdatecomparisonoperators: ['равно', 'не равно', 'меньше', 'меньше или равно', 'больше', 'больше или равно', 'null', 'not null'],
                 filterbooleancomparisonoperators: ['равно', 'не равно'],
                 validationstring: "Введенное значение не верно",
                 emptydatastring: "Нет данных",
                 filterselectstring: "Задайте фильтр",
                 loadtext: "Загрузка ...",
