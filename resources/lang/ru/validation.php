...
return [
    ...
    */
    'attributes'           => [
        ...
        'column_code' => 'код графы',
        'column_index' => 'порядковый номер графы',
        'column_name' => 'имя графы',
        'columns' => 'столбцы',
