...
@section('inlinejs')
    ...
    <script type="text/javascript">
        ...
        $("#moTree").jqxTree({ height: '550px', width: '100%', checkboxes: true, theme: theme });
        $("#moTree").jqxTree('collapseAll');
        ...
        $('#userList').on('rowselect', function (event) {
            ...
            $.getJSON( user_scope_url, function( data) {
                ...
                if (s === 0) {
                    ...
                    console.log($("#"+s.ou_id));
                    tree_el = $("#" + s.ou_id)[0];
                    $("#moTree").jqxTree('checkItem', tree_el, true);
                    $('#moTree').jqxTree('expandItem', tree_el);
                    $('#moTree').jqxTree('ensureVisible', tree_el);
                    $('#moTree').jqxTree('selectItem', tree_el);
                }
